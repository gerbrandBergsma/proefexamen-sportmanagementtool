    ...
    <v-main>
      <v-container>
        ...
        <p>
          ...
          ondersteunt of gedetailleerde statistieken wilt bijhouden, onze
          applicatie geeft je de controle en inzichten die je nodig hebt.
        </p>
        ...
        <p>
          Begin vandaag nog en ontdek hoe eenvoudig het kan zijn om je sportclub
          digitaal te beheren en te laten groeien!
        </p>
      </v-container>
    </v-main>
